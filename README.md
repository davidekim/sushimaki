...
## Installation
You can install and run this package from a [google colab notebook](https://colab.research.google.com/github/davidekim/sushimaki/blob/main/sushimaki.ipynb)
